...
::: callout-tip
There are multiple methods and packages that allow you to put plots side by side. One of my favorite for ggplot is the {patchwork} R package. You might also look into the code-chunk options `#| layout: `
