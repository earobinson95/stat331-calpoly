...
[Download starter .qmd file](murder-in-sql-city.qmd)

For this lab, you will be using table joins to solve a murder mystery.
...
Your answer must be complete and easy to follow.
...
## (Optional, for fun!) Cancel `filter()`
