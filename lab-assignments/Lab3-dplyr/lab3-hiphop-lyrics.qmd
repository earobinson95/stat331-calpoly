...
**5. Clean the data set in whichever ways you see fit. This might mean adjusting *variable type*, for example from `character` or `numeric` to `factor`, or dealing with missing data. Assign your cleaned data set to a new data set named `hiphop_clean` -- use this data set going forward.**
...
**9. Make at least two plots to display the demographic information of the subjects in this study.**
...
**12. White men above the age of 30.**
...
## Challenge 3: Article Comparisons & Critique (+10)
...
**A. Which genre had much higher average (mean or median) reported artists in one group than the other.**
...
Re-read the [data description (link)](http://conservancy.umn.edu/bitstream/handle/11299/116327/5/explanationAAEHiphopChesley.txt) to see how participants were recruited for participation in this study.

You are welcome to read additional details regarding aspects of the study in the published paper: [You Know What It Is: Learning Words through Listening to Hip-Hop](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0028248)

**B. Based on the design of this study and its context (African American English), what are at least two concerns you have?**
