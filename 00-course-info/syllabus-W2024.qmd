...
officehr_wdays <- c("Mon","Tues", "Wed", "Thu")
...
**Office Hours** are held in my office (25-113) during the following times:
...
**Objective**: Enhance your learning experience in statistical computing by actively tracking your progress, reflecting on challenges, and celebrating achievements. Each week, you will maintain a journal in a Quarto file, documenting new functions you've learned, errors encountered, and your overall learning journey. This reflective exercise aims to deepen your understanding and improve problem-solving skills in R programming.

**Weekly Tasks**:
- **Function Log**: Document any new R functions you learn each week, including their purpose and an example of how they're used.
- **Error Diary**: Record errors you encounter, describe the issue, and note how you resolved it. This will serve as a valuable troubleshooting guide.
- **Reflection**: Write a brief reflection on your learning experiences, challenges faced, and how you plan to apply or improve upon this knowledge.

To reinforce active learning and ensure consistent engagement with the Weekly Reflection Journal, a brief quiz will be administered each week. This quiz is designed to encourage deeper reflection and understanding of the concepts learned in class, and to foster the application of R programming skills in practical scenarios. The quiz aims to ensure that you are actively participating in the learning process by maintaining your journal, applying R programming concepts, and critically analyzing your experiences and challenges. Quizzes will be submitted via Canvas and are due on Sunday at 11:59 pm each week. This quizzes will graded based on completion.


::: column-margin
An Example will be provide on Canvas 
:::
