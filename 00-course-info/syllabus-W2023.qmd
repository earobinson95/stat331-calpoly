...
questions, please use the class discussion forum. I encourage you to give your
post an informative title, so that other people can find it. For example, *“How
do I color bars in a barplot with ggplot?”* is a better discussion title than
*“help with plotting”*.
...
Each week, you will find short Check-In questions throughout the text to make
sure you are prepared for class that week. Make sure you submit your answers to
these on Canvas to get credit for your efforts. Note that the Canvas Check-In
quizzes can be submitted up to three times without a penalty - so you should get
...
Most classes, you will be given a Practice Activity to complete, to get the hang
of the week’s necessary R skills. These activities will always result in a
...
attempt to start the activities before class, so you can maximize the utility
your in-class time.
...
lab's instructions to complete tasks in `R` and turn in your knitted .html
Quarto document for to Canvas.

There will be class time on Wednesdays dedicated to working on completing lab
assignments.
...
Challenges associated with labs are due at the same time as the lab assignment.
Watch Canvas for additional Challenge Point opportunities.
...
participate in the online portions of the course will affect the participation
...
for you to turn the assignment in following the grade deduction penalties below.
+ Canvas will automatically apply a 10% grade deduction for each day past
the due date with a minimum grade of 50%. 
+ Note that solutions to Practice Activities will be posted. No Practice
...
It is my goal for everyone to feel safe and comfortable in my classroom. If
