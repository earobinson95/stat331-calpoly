...
```{r phrase-function}
make_phrase <- function(num_day, item, verb, adjective, location) {
  ...
  ### See tip below about how you will need to address number vs the number word (e.g. 10 vs ten)
  
  
  ## Step 4: For the first day, if the gift item starts with a vowel, add "an" to the beginning and if the gift item does not start with a vowel, add "a" to the beginning (e.g. a partridge in a pear tree). If it is not the first day, use just the number word (e.g. ten lords a leap)
