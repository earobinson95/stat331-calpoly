...
+ My favorite things are playing pickleball, reading, and FaceTiming my 3 year-old nephew!
...
+ a fourth-year Statistics major with a minor in computer science.

+ originally from San Jose in the Bay Area.

+ the stat club secretary and enjoys gaming & basketball!
...
## FYI: Potential Faculty Strike {auto-animate=true}

+ **When?** Third week of classes - January 22-26th
+ **I will...**
+ **You are expected to...**
+ **Brandon (LA) will...**
...
+ **When?** Third week of classes - January 22-26th
+ **I will...**
  + participate in the strike (no class + no responding to emails/discord messages Mon-Fri).
  + post all week three course materials ahead of time.
  + give each of you 2 more "grace days".
+ **You are expected to...**
+ **Brandon (LA) will...**
...
+ **I will...**
+ **You are expected to...**
  + continue working through course material asynchronously as if we were having class.
  + work with each other, discuss on discord, etc. to complete assignments.
+ **Brandon (LA) will...**
...
+ **You are expected to...**
+ **Brandon (LA) will...**
  + monitor Discord for approximately 7 hours that week.
  + potentially hold office hours in some capacity.
...
## [Lab 1: Introduction to Quarto](https://earobinson95.github.io/stat331-calpoly/lab-assignments/Lab1/Lab1-intro-to-quarto.html)
...
+ I will have office hours on Tuesday (1/16) at 3:10-4pm, following my regular Monday office hour schedule.

## To do...

+ **Lab 1: Introduction to Quarto**
  + Due Monday (1/15) at 11:59pm 
+ **FizzBuzz (up to +9 FP)**
  + Due Friday (1/19) at 11:59pm 
