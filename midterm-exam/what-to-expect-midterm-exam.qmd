...
You will be given a `.qmd` template similar to lab assignments and asked a series of short questions about the minimum wage data set, such as "Which word was most and least familiar to participants under 20 years old?"
...
You will turn in your `.html` and `.qmd` files. You will be graded on the correct output, as well as your code style and design. Each of these questions should be answered using functions from the `tidyverse`.
...
You will turn in your `.html` and `.qmd` file; only your `.html` file will be
graded. Make sure your output only answers the question asked (e.g. I don't want
