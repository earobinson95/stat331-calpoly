...
You will be asked a series of eleven questions about R, RStudio, and performing operations with the `tidyverse`, etc. These will be multiple choice, fill in the blank, and select all that apply style -- similar to the check-ins.
